...
export default function Home() {
  return (
    <div>
      ...
      >
        <div class="w-full text-gray-700 border-t shadow-sm body-font  ">
          <div class="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row lg:justify-around ">
            {/* <img src="/path/to/your/logo.png" alt="Logo" class="w-16 h-16 md:w-20 md:h-20 mb-4 object-contain lg:mb-0" /> */}
            <nav class="flex flex-wrap items-center text-base lg:w-2/5 md:m-auto ">
              <a
                href="#_"
        ...
        */}
           ...
           "
            ...
            <div class="inline-flex items-center h-full ml-5 lg:w-2/5 lg:justify-end lg:m-auto">
              <a
                href="#_"
                class="px-14 py-4 text-xs font-bold text-white uppercase transition-all duration-150 bg-teal-500  shadow outline-none active:bg-teal-600 hover:shadow-md focus:outline-none ease"
                target="_blank"
              >
                Sign Up
              </a>
...
<footer class="bg-white bg-blue-800">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <hr class="my-6 border-gray-200 sm:mx-auto bg-blue-500 lg:my-8" />
